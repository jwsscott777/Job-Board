...
<template>
  ...
  <div v-if="job" class="job-Page">
    <img alt="Vue logo" src="../assets/mcfatLogo.png" />
      ...
      <h5>Click below to access Career Source Broward</h5>
      <button @click="redirect('https://www.collegecentral.com/mcfattertech')" class="csb">Career Source Broward</button>
  </div>
